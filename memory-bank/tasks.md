...
- **Следующий шаг:** Step 3 - harness capability refresh + Codex hook adapter (live/config probe, замена статичного `deny|audit|none` на `documented|live-verified|degraded`), ТОЛЬКО отдельным контрактом; не начинать до стабильного Step 1-2.
<!-- TASK #0044 END -->
