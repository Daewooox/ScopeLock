...
const FIX_BY_CODE: Readonly<Record<string, string>> = {
  ...
  HOOK_SELF_PROTECTED: "Do not change ScopeLock control-plane files during this task.",
  ...
  HOOK_CONFIG_ERROR: "Correct the ScopeLock hook configuration before retrying.",
